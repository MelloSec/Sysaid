# Removes As much of the HP Pre-loaded on their devices, some of which interfere with Defender Antivirus
# Some componenets require a second-pass of running the script once the first set of products are removed
